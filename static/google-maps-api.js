...
function searchPlaces() {
    ...
    var searchPlacesUrl = `http://accessable-maps-places.centralus.azurecontainer.io/api/lookup_places/api/lookup_places?input=${encodeURI(arrival)}&location=${location}`;
